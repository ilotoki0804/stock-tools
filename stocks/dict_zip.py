"""dict_zip by James Murphy at mCoding (MIT License), with some twicks.

Link: https://github.com/mCodingLLC/VideosSampleCode/blob/master/videos/101_zip_dict/zip_dict.py
"""
...
def dict_zip(*dicts):  # type: ignore
    if not dicts:
        return
